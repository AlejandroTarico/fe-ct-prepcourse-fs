...
function crearGato(nombre, edad) {
   ...
   persona.edad = edad;
   persona.meow = function retornaAlgo() {
      return 'Meow!';
   }
   return persona;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Precio final ---> 8
   // Tu código:
   objetoProducto.calcularPrecioDescuento = function calcularPrecDescto() {
      var totalDescuento = this.precio * this.porcentajeDeDescuento;
      return this.precio - totalDescuento;
   }
