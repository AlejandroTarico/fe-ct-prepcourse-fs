...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var promediosNotas = 0;
   var notas = 0;
   for (var i = 0; i < resultadosTest.length; i++) {
      notas = notas + resultadosTest[i];
   }
   promediosNotas = notas / resultadosTest.length;
   return promediosNotas;
}
...
function breakStatement(num) {
   ...
   for (var i = 0; i < 10; i++) {
      sumaValor += 2;
      if (sumaValor === i) break;
      else valorNuevo.push(sumaValor);
   }
